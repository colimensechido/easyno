...
**Importante:** `git pull` sincroniza **código**, no la base SQLite. La DB de producción vive en el volumen Docker `db_data`. Tras desplegar, el backend reactiva automáticamente todos los productos/assets en cada arranque.
...
```text
[eycon] Catalog sync: catálogo=66, productos activos=85, inactivos=0, reactivados=19
```
