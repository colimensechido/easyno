...
export function createClassicBoard() {
  return [
    ...
    railroadSpace({ index: 5, id: "reading_railroad", name: "Ferrocarril Reading" }),
    streetSpace({
      index: 6,
      id: "oriental_avenue",
    ...
    utilitySpace({ index: 12, id: "electric_company", name: "Compania Electrica" }),
    streetSpace({
      index: 13,
      id: "states_avenue",
      name: "Avenida States",
    ...
    railroadSpace({ index: 15, id: "pennsylvania_railroad", name: "Ferrocarril Pennsylvania" }),
    streetSpace({
      index: 16,
      id: "st_james_place",
      name: "Plaza St. James",
    ...
    railroadSpace({ index: 25, id: "bo_railroad", name: "Ferrocarril B&O" }),
    streetSpace({
      index: 26,
      id: "atlantic_avenue",
      name: "Avenida Atlantic",
      colorGroup: "yellow",
      price: 260,
      mortgageValue: 130,
      houseCost: 150,
    ...
    utilitySpace({ index: 28, id: "water_works", name: "Compania de Agua" }),
    streetSpace({
      index: 29,
      id: "marvin_gardens",
    ...
    railroadSpace({ index: 35, id: "short_line", name: "Ferrocarril Short Line" }),
